        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-8 col-md-7 py-4">
                    ...
                    <p class="text-muted">A comprehensive booking site for all your accommodation needs.</p>
                </div>
...
<main role="main">
    ...
    <section class="jumbotron text-center">
        <div class="container pt-lg-5 pl-5 px-5">
            <h1 class="display-3">A brand new hotel comparison site beyond ordinary</h1>
    ...
    <div class="container">
        <div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
            ...
            <p class="lead">Rooms are available from over 10000 accommodation vendors from only R599 per night.</p>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <div class="card mb-4 box-shadow">
                        <div class="card-header">
                            <h5 class="my-0 font-weight-normal">Holy Hill Guest House</h5>
                        </div>
                        ...
                        <div class="card-body">
                            <p class="card-text">The ultimate sanctuary to recharge the senses, the beautifully-appointed rooms exudes sheer sophistication and elegance. Each room is characterised by elevated ceilings and full length bay windows, transforming your living space into an atmospheric abode.</p>
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <small class="text-muted">R599/ night</small>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card mb-4 box-shadow">
                        <div class="card-header">
                            <h5 class="my-0 font-weight-normal">Osner Hotel</h5>
                        </div>
                        ...
                        <div class="card-body">
                            <p class="card-text">All rooms are equipped with either two single beds or one queen size bed to house two people. An enticing set of top notch facilities to the optimum security level, a fully air conditioned room remains the perfect choice for your needs. Book hotel rooms with us and enjoy your trip with full fervor.</p>
                            <div class="d-flex justify-content-between align-items-center">
                                <?php if ($isSessionExists) { ?>
                                ...
                                <?php } ?>
                                <small class="text-muted">R799 / night</small>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card mb-4 box-shadow">
                        <div class="card-header">
                            <h5 class="my-0 font-weight-normal">Blue Lagoon Hotel</h5>
                        </div>
                        ...
                        <div class="card-body">
                            <p class="card-text">Modestly sized rooms with en suite bathroom with shower and/or bathtub, a hairdryer and complimentary toiletries. Amenities include free WiFi, a telephone, a minibar, and a flat-screen TV with a variety of channels and films.</p>
                            <div class="d-flex justify-content-between align-items-center">
                                <?php if ($isSessionExists) { ?>
                                ...
                                <?php } ?>
                                <small class="text-muted">R999 / night</small>
                            </div>
                        </div>
                    </div>
                </div>
